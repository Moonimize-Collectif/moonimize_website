...
// size and font.
export default function Title_screen({firstTitle, secondTitle, customSize, display,marginTop, marginBottom, colorFirstTitle, colorSecondTitle, sizeSecondTitle, sizeFirstTitle, textAlign, paddingLeft} :any) {
    return (
    // <div className={styles.divTitle} style={{display: "flex",marginTop: marginTop , marginBottom: marginBottom, textAlign: textAlign, paddingLeft: paddingLeft}}>
       ...
       <div className={styles.divTitle} style={{display: "flex",flexDirection:"column", justifyContent:"center", alignItems:textAlign,marginTop: marginTop , marginBottom: marginBottom,paddingLeft: paddingLeft}}>
        <h2 className={customSize ? styles.secondTitle : styles.secondTitleInPage} style={{color: colorSecondTitle, fontSize: sizeSecondTitle }}>{secondTitle}</h2>
        <h1 className={customSize ? styles.firstTitle : styles.firstTitleInPage} style={{color: colorFirstTitle, fontSize: sizeFirstTitle }}>{firstTitle}</h1>
      </div>
    );
};