...
// size and font.
export default function Title_screen({firstTitle, secondTitle, marginTop, marginBottom, colorFirstTitle, colorSecondTitle, sizeSecondTitle, sizeFirstTitle} :any) {
    return (
      <div className={styles.divTitle} style={{marginTop: marginTop , marginBottom: marginBottom}}>
